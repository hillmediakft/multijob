				...
				<!-- BEGIN PAGE HEADER-->
					...
					<div class="page-bar">
						<ul class="page-breadcrumb">
							...
							<li><span>Iroda hozzáadása</span></li>
						</ul>
					</div>
								...
								<div class="row">	
                                    ...
                                    <!-- IRODA MEGNEVEZÉSE -->	
										<div class="form-group">
											...
											<input type="text" name="office_name" id="office_name" class="form-control input-xlarge" />
										</div>
									<!-- IRODA CÍM -->
								        <div class="form-group">
											<label for="office_address" class="control-label">Cím <span class="required">*</span></label>
											<input type="text" name="office_address" id="office_address" class="form-control input-xlarge" />
										</div>	
									<!-- TELEFON -->
								        <div class="form-group">
											<label for="office_telefon" class="control-label">Telefon</label>
											<input type="text" name="office_telefon" id="office_telefon" class="form-control input-xlarge" />
										</div>	
									<!-- MOBILTELEFON -->	
										<div class="form-group">
											<label for="office_mobil" class="control-label">Mobil</label>
											<input type="text" name="office_mobil" id="office_mobil" class="form-control input-xlarge" />
										</div>
									<!-- FAX -->	
										<div class="form-group">
											<label for="office_fax" class="control-label">Fax</label>
											<input type="text" name="office_fax" id="office_fax" class="form-control input-xlarge" />
										</div>
									<!-- EMAIL -->	
										<div class="form-group">
											<label for="office_email" class="control-label">E-mail</label>
											<input type="text" name="office_email" id="office_email" class="form-control input-xlarge" />
										</div>										
									<!-- NYITVATARTÁS -->	
										<div class="form-group">
											<label for="office_opening" class="control-label">Nyitvatartás</label>
		    								<textarea name="office_opening" id="office_opening" class="form-control input-xlarge" rows="5"></textarea>
									...
									<!-- HELYZET SZÉLESSÉGI KOORDINÁTA  -->
								        <div class="form-group">
											...
											<input type="text" name="office_latitude" id="office_latitude" class="form-control input-xlarge" />
										</div>	
									<!-- HELYZET HOSSZÚSÁGI KOORDINÁTA  -->	
										<div class="form-group">
											<label for="office_longitude" class="control-label">Hosszúsági koordináta</label>
											<input type="text" name="office_longitude" id="office_longitude" class="form-control input-xlarge" />
										</div>
