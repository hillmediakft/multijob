					...
					<form action="" method="POST" id="pre_register_form" name="pre_register_form">	
						<div class="row">
							...
							<div class="span4">
								...
								<div class="control-group">
									<label for="mother_name" class="control-label">Anyja neve (leánykori) <span class="form-required">*</span></label>
									<div class="controls">
							...
							<div class="span4">
								...
								<div class="control-group">
									...
									<div class="controls">
										<select id="school_type" class="chosen-select" >
											<option id="altalanos">Általános iskola</option>
											<option id="kozepiskola">Középiskola</option>
											<option id="foiskola">Főiskola / egyetem</option>
										</select>
									</div>
								</div>
							...
							<div class="span9">
								<button type="submit" class="btn btn-primary" id="pre_register_submit">Adatlap küldése</button>
							</div>
