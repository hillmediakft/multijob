...
if (isset($_SERVER['SERVER_ADDR']) && ($_SERVER['SERVER_ADDR'] == '127.0.0.1' || $_SERVER['SERVER_ADDR'] == '::1'))
{
    ...
    define('BASE_URL', 'http://multijob/'); //Az oldal elérési útjának beállítása
	...
	define('BASE_URL', 'http://multijob.onlinemarketingguru.hu/'); //Az oldal elérési útjának beállítása
	define('BASE_PATH', ''); //A domainnév utáni elérési út beállítása
